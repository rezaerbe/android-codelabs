package com.erbe.hilt.contentprovider

import android.content.*
import android.database.Cursor
import android.net.Uri
import com.erbe.hilt.data.LogDao
...
/** The authority of this content provider.  */
private const val AUTHORITY = "com.erbe.hilt.provider"
...
class LogsContentProvider : ContentProvider() {
     ...
     */
    fun getLogDao(appContext: Context): LogDao {
