...
import com.erbe.people.BubbleActivity
import com.erbe.people.MainActivity
import com.erbe.people.R
import com.erbe.people.util.ReplyReceiver
...
class NotificationHelper(private val context: Context) {
        ...
        var shortcuts = Contact.CONTACTS.map { contact ->
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.Q) {
                ShortcutInfo.Builder(context, contact.shortcutId)
                    ...
                    .setIcon(icon)
                    .setLongLived(true)
                    .setCategories(setOf("com.erbe.bubbles.category.TEXT_SHARE_TARGET"))
                    .setIntent(
    ...
    fun showNotification(chat: Chat, fromUser: Boolean) {
        ...
        val icon = Icon.createWithContentUri(chat.contact.iconUri)
