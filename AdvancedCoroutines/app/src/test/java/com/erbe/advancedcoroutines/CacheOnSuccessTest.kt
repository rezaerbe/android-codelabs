package com.erbe.advancedcoroutines

import com.erbe.advancedcoroutines.utils.CacheOnSuccess
...
class CacheOnSuccessTest {
    ...
    @Test
    fun getOrAwait_fallsBackOnException_withMultipleAwait() = runBlockingTest {
        var calls = 0
        val subject = CacheOnSuccess(onErrorFallback = { calls++ }) {
            delay(100)
            throw SomeException()
